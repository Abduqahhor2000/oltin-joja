            ...
            <>
              {filteredProducts.map((product, index) => {
                return (
                  ...
                  >
                    <div className="h-48 w-full bg-zinc-200 rounded-[10px] mb-4 cursor-pointer overflow-hidden">
                      <img
              ...
              {[1, 2, 3, 4, 5, 6].map((item) => {
                return (
                  <div key={item} className="w-[calc((100%-60px)/3)] animate-pulse bg-white rounded-[10px] mt-2.5 mb-5 p-2.5 pb-4 mr-4 font-medium ">
                    ...
                    <span className={`w-full block h-10 rounded-[10px] bg-Primary/03 `}></span>
                  </div>
                );
              })}
            </>
